...
sig_list=['TTBar_train___40_30_30_pt_part_TTBar.h5']
bg_list=['ZJetsToNuNu_train___40_30_30_pt_part_ZJetsToNuNu.h5']
num_epochs_list=[30]
dropout_list=[0.0]
num_heads_list=[4]
num_layers_list=[8]
...
tag_of_train='top_vs_qcd_jetclass_classifier_part_pt_test_2'
