...
sig_list=['/TTBar_models/Part_pt_1/TTBar_run_test__part_pt_const128_403030_3_O0KHIRP/samples_samples_nsamples10000000_trunc_5000.h5']
bg_list=['/ZJetsToNuNu_models/Part_pt_1_zjetnunu/ZJetsToNuNu_run_test__part_pt_const128_403030_3_N5LN6TI/samples_samples_nsamples10000000_trunc_5000.h5']
num_epochs_list=[50]
dropout_list=[0.0]
num_heads_list=[4]
num_layers_list=[8]
