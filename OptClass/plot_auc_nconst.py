...
dir_classifier_results=test_results_dir+'top_vs_qcd_transformerdata_classifier_test_2_NYJA2XG/'
...
for num_const in num_const_list:
    ...
    predicitions_test=GetPredictions(dir_classifier_results,num_const)
...
plt.title(plot_title,loc='left')
plt.savefig(path_to_plots+'/plot_ROCcurve_nconst.pdf')
plt.close()
