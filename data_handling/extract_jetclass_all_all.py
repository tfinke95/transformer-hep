...
# %%
    ...
    all_constituents = np.concatenate(all_constituents, axis=0)
    print(all_constituents.shape)
    to_hdf_file(all_constituents, out_file=out_file)
