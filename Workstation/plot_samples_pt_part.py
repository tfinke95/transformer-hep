...
dict_of_names={'TTBar':"$t \rightarrow bqq^{\prime} $",'ZJetsToNuNu':"$g/q$",'HToBB':"$H\rightarrow b\bar b $",'HToCC':"$H \rightarrow c \bar c$",'HToGG':"$H \rightarrow gg$",'HToWW2Q1L':"$H \rightarrow lvqq^{\prime}$",'HToWW4Q':"$H \rightarrow 4q$",'TTBarLep':"$H \rightarrow blv$",'WToQQ':"$W \rightarrow  qq^{\prime}$",'ZToQQ':"$Z \rightarrow q \bar q$"}
