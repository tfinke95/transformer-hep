...
for jet in list_of_jets:
    ...
    tag_oftrain=jet+'_run_test__part_pt_1Mfromeach_403030_test_1'
    data_path='/net/data_t2k/transformers-hep/JetClass/discretized/'+jet+'_train___1Mfromeach_403030.h5'
    ...
    test_dataset='/net/data_t2k/transformers-hep/JetClass/discretized/'+jet+'_test___1Mfromeach_403030.h5'
    ...
    n_samples=200000
    test_data_name='/discretized/'+jet+'_test___1Mfromeach_403030.h5'
